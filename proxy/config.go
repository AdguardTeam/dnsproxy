...
type Config struct {
	...
	// MessageConstructor is an optional custom message constructor.  It's used
	// to build DNS messages.
	...
	// private and will be forwarded as PrivateRDNSUpstreamConfig specifies, so
	// it requires the PrivateRDNSUpstreamConfig to be set.
	UseDNS64 bool
	...
	// should be resolved via PrivateRDNSUpstreamConfig.
	UsePrivateRDNS bool
}
