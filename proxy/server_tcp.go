...
// logTCPConnError writes suitable log message for given err.
func logTCPConnError(err error, l net.Listener) {
...
func readDNSReq(conn net.Conn) (req *dns.Msg) {
