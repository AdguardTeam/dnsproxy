...
func TestSortIPAddrs(t *testing.T) {
	ipAddrs := []net.IPAddr{}
	ipAddrs = append(ipAddrs, net.IPAddr{IP: net.ParseIP("94.140.15.16").To4()})
	...
	assert.Equal(t, ipAddrs[1].String(), "94.140.15.16")
...
func TestContainsIP(t *testing.T) {
	ips := []net.IP{}
	ips = append(ips, net.ParseIP("94.140.15.16"))
	ips = append(ips, net.ParseIP("2a10:50c0::bad1:ff"))

	ip := net.ParseIP("94.140.15.16")
